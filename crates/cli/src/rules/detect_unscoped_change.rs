...
use gh_verify_core::scope::{
    classify_file_role, classify_scope, is_non_code_file, resolve_import,
    should_bridge_aux_to_source, should_bridge_colocated_sources,
    should_bridge_fork_variants, should_bridge_test_fixture_pair, FileRole,
};
